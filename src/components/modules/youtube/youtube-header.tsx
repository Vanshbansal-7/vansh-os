...
import { ArrowLeft, Search, Bell, Play } from "lucide-react";
...
export function YouTubeHeader({
  searchPlaceholder = "Search in YouTube...",
  searchValue = "",
  onSearchChange,
}: YouTubeHeaderProps) {
  ...
  return (
    <div className="flex items-center justify-between gap-4 py-2 border-b border-white/[0.04] mb-3">
      {/* Back to Dashboard Navigation + Icon & Title */}
      <div className="flex items-center gap-3">
        ...
        <div className="w-7 h-7 rounded-lg bg-rose-500/15 border border-rose-500/25 flex items-center justify-center text-rose-400">
          <Play className="w-3.5 h-3.5 fill-rose-400 ml-0.5" />
        </div>
      </div>
